...
const faqs = [
  {
    ...
    answer:
      'Yes. We use official LinkedIn APIs and secure session management. Your credentials are encrypted and we only request the minimum permissions needed to post and engage on your behalf. Thousands of professionals trust POSTORA as their LinkedIn studio.',
  },
  {
    question: 'Can I schedule carousels?',
    answer:
      'Absolutely. POSTORA supports all LinkedIn post types including single images, carousels (multi-image posts), videos, and text-only posts. Our carousel builder makes it easy to upload and arrange multiple slides so your posts look polished.',
  },
  {
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div ref={headerRef} className="text-center mb-8 sm:mb-12">
          <p className="mono text-xs uppercase tracking-[0.12em] text-[#6366F1] font-medium mb-3 sm:mb-4">
            FAQ
          </p>
