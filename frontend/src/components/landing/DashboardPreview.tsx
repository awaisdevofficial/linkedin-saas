              ...
              <div className="flex items-center justify-between p-6 border-b border-[#6B7098]/10">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="pl-10 pr-4 py-2 rounded-full bg-[#F6F8FC] text-sm text-[#10153E] placeholder:text-[#6B7098]/60 w-64 focus:outline-none focus:ring-2 focus:ring-[#4F6DFF]/20"
                  />
                </div>
                <div className="flex items-center gap-4">
                  <button className="relative p-2 rounded-full hover:bg-[#F6F8FC]">
                    <Bell className="w-5 h-5 text-[#6B7098]" />
                    <span className="absolute top-1 right-1 w-2 h-2 bg-[#4F6DFF] rounded-full" />
                  </button>
