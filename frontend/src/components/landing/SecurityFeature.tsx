    ...
    >
      ...
      >
        <div className="w-full max-w-lg mx-auto lg:mx-0 lg:px-[7vw] lg:max-w-[500px]">
          <div
            ref={iconRef}
            className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#4F6DFF]/10 flex items-center justify-center mb-6 lg:mb-8"
          >
            <Shield className="w-6 h-6 sm:w-7 sm:h-7 text-[#4F6DFF]" />
          </div>
          <p className="mono text-xs uppercase tracking-[0.12em] text-[#4F6DFF] font-medium mb-3 lg:mb-4">
            Security
          </p>
          ...
          <button
            type="button"
            className="inline-flex items-center gap-2 text-[#4F6DFF] font-medium hover:gap-3 transition-all group min-h-[44px] touch-manipulation"
          >
