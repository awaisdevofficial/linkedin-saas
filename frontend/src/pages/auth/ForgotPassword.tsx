          ...
          {!isSubmitted ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-12 rounded-xl border-[#6B7098]/20 focus:border-[#6366F1] focus:ring-[#6366F1]/20 pl-12"
                      required
                    />
                  </div>
                </div>
            ...
            <>
              ...
              <div className="space-y-3">
                <Link to="/auth/login">
                  <Button className="w-full h-12 bg-[#6366F1] hover:bg-[#4F46E5] text-white rounded-full font-medium">
                    Back to login
                  </Button>
                </Link>
                <Button
