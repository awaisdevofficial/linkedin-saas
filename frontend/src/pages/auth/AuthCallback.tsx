    ...
    return (
      <div className="min-h-dvh min-h-screen bg-[#F6F8FC] flex items-center justify-center p-4 overflow-x-hidden">
        <div className="bg-white rounded-[28px] p-8 card-shadow max-w-md text-center">
          ...
          <a href="/auth/login" className="text-[#6366F1] hover:underline">
            Back to Login
          </a>
        </div>
      </div>
  ...
  return (
    <div className="min-h-dvh min-h-screen bg-[#F6F8FC] flex items-center justify-center p-4 overflow-x-hidden">
      <div className="text-center">
        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#6366F1] to-[#818CF8] flex items-center justify-center mx-auto mb-4 animate-pulse" />
        <p className="text-[#6B7098] mb-4">Signing you in...</p>
        {hasHash && (
          <p className="text-sm text-[#6B7098]">
            If nothing happens, <a href="/dashboard" className="text-[#6366F1] hover:underline font-medium">continue to Dashboard</a>.
          </p>
        )}
      </div>
    </div>
