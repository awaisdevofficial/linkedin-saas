...
import { Shield, LayoutDashboard, Users, FileText, ScrollText, LogOut, ToggleLeft, Menu, X } from 'lucide-react';
    ...
    <>
      <div className="p-4 border-b border-[#6B7098]/10 flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <span className="font-semibold text-[#10153E] truncate">Postpilot Admin</span>
        </div>
        {role && (
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden flex items-center justify-between gap-3 px-4 py-3 bg-white border-b border-[#6B7098]/10 shrink-0">
          ...
          <div className="flex items-center gap-2 min-w-0">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#2D5AF6] to-[#27C696] flex items-center justify-center shrink-0">
              <Shield className="w-4 h-4 text-white" />
            </div>
            <span className="font-semibold text-[#10153E] truncate">Admin</span>
          </div>
