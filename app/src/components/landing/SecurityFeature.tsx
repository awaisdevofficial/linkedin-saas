    ...
    >
      ...
      >
        <div className="px-[7vw] max-w-[500px]">
          ...
          <div 
            ref={iconRef}
            className="w-14 h-14 rounded-2xl bg-[#2D5AF6]/10 flex items-center justify-center mb-8"
          >
            <Shield className="w-7 h-7 text-[#2D5AF6]" />
          </div>
          ...
          {/* CTA */}
          <button className="inline-flex items-center gap-2 text-[#2D5AF6] font-medium hover:gap-3 transition-all group">
