          ...
          {plans.map((plan, i) => (
            <div
              ...
              className={`pricing-card relative bg-white rounded-[28px] p-8 border ${
                plan.popular 
                  ? 'border-t-4 border-t-[#2D5AF6] border-x-[#6B7098]/18 border-b-[#6B7098]/18' 
                  : 'border-[#6B7098]/18'
              } card-shadow`}
            >
              {plan.popular && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <span className="px-4 py-1 bg-[#2D5AF6] text-white text-xs font-medium rounded-full">
                    Most popular
                  </span>
                </div>
              )}
              ...
              <Link to="/auth/signup">
                <Button 
                  ...
                  className={`w-full h-12 rounded-full ${
                    plan.popular 
                      ? 'bg-[#2D5AF6] hover:bg-[#1E4AD6] text-white' 
